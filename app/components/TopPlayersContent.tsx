...
const TopPlayersContent = () => {
    ...
    [8, <div className="flex items-center gap-[35px]">
            <Image width={15.5} height={15.5} src={LevelBadge} alt="LevelBadge" />
            13
        </div>, 'Nara', '10,114230',<p className="text-[#01C601]">95%</p>, 
        <div className="flex items-center gap-[15px]">
            Pirate lord
            <Image src={RankCup} alt="RankCup" />
        </div>, <button onClick={(e) => handleEditClick(e, 1, 'Nara')} className="w-[84.3px] h-[24px] bg-[#4DAFF2] text-white text-[11.63px] leading-[23.26px] font-normal tracking-[0.15%] rounded-[24px]">Edit</button>],
    [9, <div className="flex items-center gap-[35px]">
            <Image width={15.5} height={15.5} src={LevelBadge} alt="LevelBadge" />
            12
        </div>, 'Juliet', '8,114230',<p className="text-[#01C601]">90%</p>, 
        <div className="flex items-center gap-[15px]">
    ...
    [10, <div className="flex items-center gap-[35px]">
            <Image width={15.5} height={15.5} src={LevelBadge} alt="LevelBadge" />
            11
        </div>, 'Jasmine', '7,114230',<p className="text-[#01C601]">80%</p>, 
        <div className="flex items-center gap-[15px]">
    ...
    [11, <div className="flex items-center gap-[35px]">
            <Image width={15.5} height={15.5} src={LevelBadge} alt="LevelBadge" />
            10
        </div>, 'Tariq', '6,114230',<p className="text-[#01C601]">70%</p>, 
        <div className="flex items-center gap-[15px]">
    ...
    [12, <div className="flex items-center gap-[35px]">
            <Image width={15.5} height={15.5} src={LevelBadge} alt="LevelBadge" />
            7
        </div>, 'John', '5,114230',<p className="text-[#01C601]">60%</p>, 
        <div className="flex items-center gap-[15px]">
            Gold hoarder
            <Image src={RankCup} alt="RankCup" />
        </div>, <button onClick={(e) => handleEditClick(e, 1, 'John')} className="w-[84.3px] h-[24px] bg-[#4DAFF2] text-white text-[11.63px] leading-[23.26px] font-normal tracking-[0.15%] rounded-[24px]">Edit</button>],
    [13, <div className="flex items-center gap-[35px]">
            <Image width={15.5} height={15.5} src={LevelBadge} alt="LevelBadge" />
            9
        </div>, 'Joel', '3,114230',<p className="text-[#01C601]">65%</p>, 
        <div className="flex items-center gap-[15px]">
            Coin collector
            <Image src={RankCup} alt="RankCup" />
        </div>, <button onClick={(e) => handleEditClick(e, 1, 'Joel')} className="w-[84.3px] h-[24px] bg-[#4DAFF2] text-white text-[11.63px] leading-[23.26px] font-normal tracking-[0.15%] rounded-[24px]">Edit</button>],
    [14, <div className="flex items-center gap-[35px]">
            <Image width={15.5} height={15.5} src={LevelBadge} alt="LevelBadge" />
            8
        </div>, 'Victor', '2,114230',<p className="text-[#01C601]">60%</p>, 
        <div className="flex items-center gap-[15px]">
            legendary gold
            <Image src={RankCup} alt="RankCup" />
        </div>, <button onClick={(e) => handleEditClick(e, 1, 'Victor')} className="w-[84.3px] h-[24px] bg-[#4DAFF2] text-white text-[11.63px] leading-[23.26px] font-normal tracking-[0.15%] rounded-[24px]">Edit</button>],
    [15, <div className="flex items-center gap-[35px]">
            <Image width={15.5} height={15.5} src={LevelBadge} alt="LevelBadge" />
            7
        </div>, 'Jake', '2,114230',<p className="text-[#01C601]">60%</p>, 
        <div className="flex items-center gap-[15px]">
            legendary gold
            <Image src={RankCup} alt="RankCup" />
        </div>, <button onClick={(e) => handleEditClick(e, 1, 'Jake')} className="w-[84.3px] h-[24px] bg-[#4DAFF2] text-white text-[11.63px] leading-[23.26px] font-normal tracking-[0.15%] rounded-[24px]">Edit</button>],
  ];
